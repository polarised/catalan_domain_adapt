#TRAIN POS TAGGER DEBUG VERSION 
...
OUTPUT_DIR = "./pos_tagger_debug_model"

EPOCHS = 1
BATCH_SIZE = 2
LR = 5e-5
MAX_LEN = 128
DEBUG_SIZE = 100  # use only first 100 sentences
...
dataset = load_pickle(data_path)[:DEBUG_SIZE]
print(f"Loaded {len(dataset)} sentences for debug")
...
print("\nDebug training complete. Model saved to:", OUTPUT_DIR)
